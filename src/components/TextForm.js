        ...
        <>
            <div className="container" style={{ color: props.mode === 'dark' ? 'white' : 'black' }}>
                ...
                <div className="d-grid gap-2 d-md-flex justify-content-md-start">
                    ...
                    <button className="btn btn-dark mx-1 my-1" onClick={handleReverseClick}>Reverse Text</button>
                    <button className="btn btn-dark mx-1 my-1" onClick={handleSpeakClick}>Speak</button>
                    <button className="btn btn-dark mx-1 my-1" onClick={handleExtraSpaces}>Remove Spaces</button>
                    <button className="btn btn-dark mx-1 my-1" onClick={handleClearClick}>Clear All</button>
                </div>
            </div>
